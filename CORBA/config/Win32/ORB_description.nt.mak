...
IDL_LIBDIR = -libpath:"$(MICO_ROOT)\win32-bin\lib" -libpath:"$(MICO_ROOT)\coss" -libpath:"$(PTHREADS_ROOT)"
ORB_LIBS = mico239.lib idl239.lib 
# TODO: enable threading support in next version.
#pthreadVC.lib 
ORB_COSNAMING_LIB = micocoss239.lib 
PATH=$(MICO_ROOT)\win32-bin;$(PATH)

ORB_INCLUDES = -I$(MICO_ROOT)\include
