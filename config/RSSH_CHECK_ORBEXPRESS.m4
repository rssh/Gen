...
dnl $Id: RSSH_CHECK_ORBEXPRESS.m4,v 1.2 2002-05-21 13:03:40 rssh Exp $
dnl
...
ORBEXPRESS_LIBDIRS="-L$ORBEXPRESS_PREFIX/lib"
ORBEXPRESS_LIBS="-lOEbridge -lOEipmc -lOEmirror -lOEorb -lOEtcp"
ORB_LIBDIRS=$ORBEXPRESS_LIBDIRS
ORB_LIBS=$ORBEXPRESS_LIBS
AC_SUBST(ORBEXPRESS_LIBDIRS)
AC_SUBST(ORBEXPRESS_LIBS)
