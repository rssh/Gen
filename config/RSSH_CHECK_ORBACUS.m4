...
dnl $Id: RSSH_CHECK_ORBACUS.m4,v 1.6 2008-06-12 10:52:35 rssh Exp $
dnl
...
LIBS="-L$OB_PREFIX/lib -lOB $JTC_LIBDIR $JTC_LIB $LIBS"
...
AC_SUBST(IDL_CLN_H_BEFOREDOT_SUFFIX,$IDL_CLN_H_BEFOREDOT_SUFFIX)
AC_SUBST(IDL_CLN_H_EXT,$IDL_CLN_H_EXT)
...
IDL_SRV_H_BEFOREDOT_SUFFIX=_skel 
IDL_SRV_H_EXT=h 
