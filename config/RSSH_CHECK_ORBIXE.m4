...
dnl $Id: RSSH_CHECK_ORBIXE.m4,v 1.2 2002-05-21 13:03:41 rssh Exp $
dnl
...
ORBIXE_LIBDIRS="-L$ORBIXE_CPP_DIR/lib -L$ORBIXE_PREFIX/c/lib"
ORBIXE_LIBS="-l$ORBIXE_CPP_LIB -lJTC_$ORBIXE_BL -lobec_server -lJTCC"
ORB_LIBDIRS=$ORBIXE_LIBDIRS
ORB_LIBS=$ORBIXE_LIBS
AC_SUBST(ORBIXE_LIBDIRS)
AC_SUBST(ORBIXE_LIBS)
AC_SUBST(ORB_LIBDIRS)
AC_SUBST(ORB_LIBS)

dnl LIBS="-L$ORBIXE_CPP_DIR/lib -L$ORBIXE_PREFIX/c/lib -l$ORBIXE_CPP_LIB -lJTC$ORBIXE_BL -lobec_server -lJTCC $LIBS"
